...
def max_diameter(x, y):
    ...
    # print("x.min(dim=0)--->shape :", x.min(dim=0).shape)
    # print("x.min(dim=0)[0]--->", x.min(dim=0)[0])
    # print("y.min(dim=0)[0]--->", y.min(dim=0)[0])
    # print("oooo---->", torch.stack((x.min(dim=0)[0], y.min(dim=0)[0])).min(dim=0))
    ...
    # print("mins-->", mins.item())
    # print("maxs-->", maxs.item())
