...
class My_dHCP_Data_mgh(torch.utils.data.Dataset):
        ...
        for file in dir_set:
            ...
            if file[-2:] == "ll":
                ...
                for sub_file in os.listdir(sub_file_path):
                    ...
                    if "lh.thickness.fsaverage.mgh" == sub_file:
                        # print("-----", sub_file)
                        target_path = os.path.join(sub_file_path, sub_file)
                ...
                for sub_file in os.listdir(sub_file_path):
                    ...
                    if "rh.thickness.fsaverage.mgh" == sub_file:
                        # print("-----", sub_file)
                        target_path = os.path.join(sub_file_path, sub_file)
    ...
    def __getitem__(self, idx):
        ...
        sample = { 'v0': torch.Tensor(features0[0]), 'f0': torch.Tensor(features0[1]), 'mgh0' : torch.Tensor(mgh_array0).squeeze(1),
        'v1': torch.Tensor(features1[0]), 'f1': torch.Tensor(features1[1]), 'mgh1' : torch.Tensor(mgh_array1).squeeze(1) }  # 这里假设 v 和 f 与 features 的结构相同
        ...
        for file in dir_set:
            ...
            if file[-2:] == "ll":
                ...
                for sub_file in os.listdir(sub_file_path):
                    ...
                    if "lh_thickness.txt" in sub_file:
                        # print("-----", sub_file)
                        target_path = os.path.join(sub_file_path, sub_file)
                        all_thick_mgh_path[file[:-2] + 'll0'].append(target_path)
                ...
                for sub_file in os.listdir(sub_file_path):
                    ...
                    if "rh_thickness.txt" in sub_file:
                        # print("-----", sub_file)
                        target_path = os.path.join(sub_file_path, sub_file)
                        all_thick_mgh_path[file[:-2] + 'rr0'].append(target_path)
