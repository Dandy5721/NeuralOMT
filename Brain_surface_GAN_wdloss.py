...
OTLoss = geomloss.SamplesLoss(
    ...
    blur=entreg**(1/1), backend='tensorized')
# pW = OTLoss(a, b)
...
if __name__ == '__main__':
    ...
    def train(data_loader):
        ...
        for batch_idx, samples in bar:
            ...
            errD_real = OTLoss(output, inputs_next)
            ...
            G_fake_loss = OTLoss(fake, inputs_next)
            ...
            G_loss = OTLoss(output_fake, D_fake)
            G_loss.backward()
            optimizer_G.step()
            optimizer_PROPCESS.step()
            optimizer_PE.step()
